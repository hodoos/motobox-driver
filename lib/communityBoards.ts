...
export const COMMUNITY_BOARD_DEFINITIONS = [
  ...
  },
  {
    ...
    menuLabel: "공지",
    title: "공지사항",
    description: "운영 공지, 업데이트 안내, 중요 알림을 확인하는 공간입니다.",
    heroKicker: "NOTICE",
    sectionTitle: "커뮤니티",
    accessLevel: "authenticated",
  },
  {
    ...
    menuLabel: "팁",
    title: "팁 공유",
    description: "업무 노하우, 운행 팁, 정산 팁을 자유롭게 공유하는 공간입니다.",
    heroKicker: "TIPS",
    sectionTitle: "커뮤니티",
    accessLevel: "authenticated",
  },
  {
    ...
    menuLabel: "제휴 게시판",
    title: "제휴 게시판",
    description: "제휴 관련 소식과 제안을 확인하는 게시판입니다.",
    heroKicker: "AFFILIATE BOARD",
    sectionTitle: "제휴 전용",
    accessLevel: "authenticated",
  },
