...
export const COMMUNITY_BOARD_DEFINITIONS = [
  {
    ...
    menuLabel: "구인/구직 게시판",
    title: "구인/구직 게시판",
    description: "채용 공고, 기사 모집, 일자리 제안과 지원 정보를 올리는 게시판입니다.",
    heroKicker: "JOBS BOARD",
    sectionTitle: "커뮤니티",
  ...
  },
  {
    ...
    menuLabel: "자유/소통 게시판",
    title: "자유/소통 게시판",
    description: "업무 일상, 현장 이야기, 질문과 답변을 자유롭게 남기는 게시판입니다.",
  ...
  },
  {
    ...
    menuLabel: "공지/이벤트 게시판",
    title: "공지/이벤트 게시판",
    description: "운영 공지, 이벤트, 변경 사항을 한곳에서 확인하는 게시판입니다.",
    heroKicker: "NOTICE BOARD",
    sectionTitle: "커뮤니티",
    accessLevel: "authenticated",
  },
  {
    key: "tips",
    path: "/community/tips",
    menuLabel: "업무/노하우 게시판",
    title: "업무/노하우 게시판",
    description: "배송 동선, 정산 팁, 현장 노하우를 공유하는 게시판입니다.",
    heroKicker: "TIPS BOARD",
    sectionTitle: "커뮤니티",
    accessLevel: "authenticated",
  },
  {
